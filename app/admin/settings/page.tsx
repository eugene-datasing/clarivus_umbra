...
const defaultDetectionToggles: DetectionToggle[] = [
...
const defaultNotifications: NotificationEvent[] = [
...
export default function SettingsPage() {
  ...
  const [detectionToggles, setDetectionToggles] = useState(defaultDetectionToggles);
  const [notifications, setNotifications] = useState(defaultNotifications);
  const [seniorReview, setSeniorReview] = useState(true);
  const [finalApproval, setFinalApproval] = useState(true);
  const [amberDays, setAmberDays] = useState(10);
    ...
    <div className="p-6 max-w-[1400px]">
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="w-20 text-right text-sm font-mono text-green-700 font-medium">
                  &ge; 85%
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="w-20 text-right text-sm font-mono text-amber-600 font-medium">
                  50 &ndash; 84%
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="w-20 text-right text-sm font-mono text-red-600 font-medium">
                  &lt; 50%
                </div>
              </div>
            </div>
              ...
              {detectionToggles.map((toggle, i) => (
                ...
                >
                  ...
                  <button
                    ...
                    title={toggle.enabled ? "Disable" : "Enable"}
                  >
                    {toggle.enabled ? (
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-txt-secondary mt-1">
                  v2.3.1 &mdash; Updated 15 Mar 2026
                </p>
              </div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 text-sm">
                <input
                  ...
                  onChange={() => setSeniorReview(!seniorReview)}
                  className="w-4 h-4 rounded accent-brand-primary"
                />
              ...
              <label className="flex items-center gap-3 text-sm">
                <input
                  ...
                  onChange={() => setFinalApproval(!finalApproval)}
                  className="w-4 h-4 rounded accent-brand-primary"
                />
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={amberDays}
                  onChange={(e) => setAmberDays(Number(e.target.value))}
                  min={1}
                />
              </div>
              <div>
      ...
      {activeTab === "health" && (
        <div className="space-y-6">
          ...
          {/* Storage usage */}
          <div className="card">
            <h2 className="text-lg font-heading font-semibold text-txt-primary mb-3">
              Storage Usage
            </h2>
            <div className="flex items-center gap-4">
              <div className="flex-1">
              ...
              <span className="text-sm font-mono text-txt-primary font-medium whitespace-nowrap">
                12.4 GB / 100 GB
              </span>
            </div>
            <p className="text-xs text-txt-secondary mt-2">
              Azure Blob Storage &mdash; NZ North region
            </p>
          </div>
