...
// Phase 12.1 (Umbra v2) — variant-C grouped-grounds dropdown tests
// removed. The LGOIMA grounds vocabulary is dropped in v2; the
// dropdown the tests guarded no longer exists. See
// docs/umbra-implementation-plan.md Phase 12.1.
