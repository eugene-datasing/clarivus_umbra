...
const newDetections: Array<Prisma.DetectionUncheckedCreateInput> = [
  ...
  { id: "det-041", documentId: "doc-006", type: "free-frank", text: "Specifically, deferring the Mangati Stream culvert renewal ($820,000) would cover the Coastal Walkway overrun and avoid public controversy about scaling back the walkway project mid-construction.", confidence: 85, page: 1, posX: 80, posY: 280, posW: 520, posH: 44, suggestedGround: "s7_2f", appliedGround: "s7_2f", status: "accepted", reasoning: "Frank staff advice on budget strategy.", piConsideration: "Free and frank advice to decision-makers.", aiExplanation: "Staff recommendation on politically sensitive budget choices.", source: "ai" },
  { id: "det-042", documentId: "doc-006", type: "free-frank", text: "If we report the overrun to the full council, it will almost certainly leak to the media. The opposition councillors will use this to attack the Mayor's project management record.", confidence: 88, page: 1, posX: 80, posY: 360, posW: 520, posH: 44, suggestedGround: "s7_2f", appliedGround: "s7_2f", status: "accepted", reasoning: "Political risk assessment.", piConsideration: "Strong free and frank opinion about council politics.", aiExplanation: "Staff assessment of political risk and media attention.", source: "ai" },
  ...
  { id: "det-216", documentId: "doc-019", type: "free-frank", text: "I'm aware of the political optics given Maxwell's previous donations to the Mayor's campaign", confidence: 81, page: 1, posX: 80, posY: 230, posW: 520, posH: 22, suggestedGround: "s7_2f", appliedGround: "s7_2f", status: "accepted", reasoning: "Political sensitivity acknowledgment.", piConsideration: "Staff candid comment about politics.", aiExplanation: "Property Manager's frank political observation.", source: "ai" },
  { id: "det-217", documentId: "doc-019", type: "free-frank", text: "Accelerating this for an extra $100K would look terrible if it leaked to the media", confidence: 84, page: 1, posX: 80, posY: 320, posW: 520, posH: 44, suggestedGround: "s7_2f", appliedGround: "s7_2f", status: "accepted", reasoning: "CEO's strategic media risk advice.", piConsideration: "Free and frank executive advice on reputational risk.", aiExplanation: "CEO's candid assessment of media risk.", source: "ai" },
  ...
  { id: "det-223", documentId: "doc-021", type: "free-frank", text: "If the insurer reduces Claim 1 by $380,000, the council will need to fund this from the emergency works budget or seek a budget variation.", confidence: 74, page: 2, posX: 80, posY: 280, posW: 520, posH: 44, suggestedGround: "s7_2f", appliedGround: null, status: "rejected", reasoning: "", piConsideration: "", aiExplanation: "Factual financial information, not free and frank opinion.", source: "ai", reviewedBy: "u-003", reviewedAt: new Date("2026-03-18T11:00:00") },
  ...
  { id: "det-227", documentId: "doc-022", type: "free-frank", text: "While we acknowledge some sections showed age-related wear, this is normal for a 40-year-old pipeline and does not constitute 'gradual deterioration' within the meaning of the policy exclusion", confidence: 81, page: 2, posX: 80, posY: 230, posW: 520, posH: 44, suggestedGround: "s7_2f", appliedGround: null, status: "rejected", reasoning: "", piConsideration: "", aiExplanation: "Legal argument, not free and frank opinion.", source: "ai", reviewedBy: "u-007", reviewedAt: new Date("2026-03-18T14:00:00") },
