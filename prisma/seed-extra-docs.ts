...
async function main() {
  ...
  const req011Dets = [
    ...
    { id: "det-123", documentId: "doc-073", type: "free-frank", text: "Several staff members reported feeling underprepared for cross-cultural engagement. One team leader noted: 'We've had no formal training since 2019, and the district's demographics have changed significantly since then.'", confidence: 77, page: 5, posX: 80, posY: 180, posW: 520, posH: 66, suggestedGround: "s7_2f", appliedGround: null, status: "pending", reasoning: "", piConsideration: "", aiExplanation: "Free and frank opinion from a staff member about the adequacy of cultural competency training. The staff member would expect this internal feedback to remain confidential.", source: "ai" },
  ];
  ...
  const det200 = [
    ...
    { id: "det-203", documentId: "doc-016", type: "free-frank", text: "The Property Manager recommends accepting Offer B despite it not being the highest possible return, as the unconditional nature and short settlement reduce execution risk. The last two conditional sales of council property fell through at significant cost.", confidence: 81, page: 8, posX: 80, posY: 150, posW: 520, posH: 66, suggestedGround: "s7_2f", appliedGround: "s7_2f", status: "accepted", reasoning: "Staff recommendation on property sale strategy, including frank assessment of risk.", piConsideration: "Free and frank advice to decision-makers on a commercial matter. Staff must be able to provide candid risk assessments.", aiExplanation: "Internal staff recommendation favouring one offer over others, with frank assessment of institutional risk based on past failed sales. This is clearly free and frank advice.", source: "ai" },
  ];
