...
async function main() {
  ...
  const detections = [
    ...
    { id: "det-005", documentId: "doc-001", type: "free-frank", text: "I recommend the committee defer the Stage 2 decision until the geotechnical report is complete. Proceeding without it exposes the council to significant liability.", confidence: 78, page: 4, posX: 80, posY: 120, posW: 520, posH: 66, suggestedGround: "s7_2fi", appliedGround: null, status: "pending", reasoning: "", piConsideration: "", aiExplanation: "Internal staff recommendation to the Infrastructure Committee. This appears to be a free and frank opinion on the timing of a significant infrastructure decision, expressing professional judgement about risk. Withholding may protect the ability of staff to provide candid advice to decision-makers.", source: "ai" },
    ...
    { id: "det-019", documentId: "doc-002", type: "free-frank", text: "The Finance Manager recommends deferring the roading programme to free up $800K for the wastewater upgrade \u2014 this is not a politically popular option", confidence: 76, page: 7, posX: 80, posY: 420, posW: 520, posH: 44, suggestedGround: "s7_2fi", appliedGround: null, status: "pending", reasoning: "", piConsideration: "", aiExplanation: "Internal staff opinion about budget prioritisation, explicitly noting political sensitivity. This is free and frank expression of opinion that staff provided in the expectation of confidentiality.", source: "ai" },
    ...
    { id: "det-023", documentId: "doc-003", type: "free-frank", text: "Between us \u2014 I think the committee is going to push back hard on the Stage 2 timeline. The Mayor wants it done before the election but the engineering just isn\u2019t there yet.", confidence: 84, page: 2, posX: 80, posY: 180, posW: 520, posH: 66, suggestedGround: "s7_2fi", appliedGround: null, status: "pending", reasoning: "", piConsideration: "", aiExplanation: "Informal staff communication expressing a frank opinion about political dynamics and project feasibility. The phrase 'between us' signals an expectation of confidence. References the Mayor which adds political sensitivity.", source: "ai" },
    ...
    { id: "det-033", documentId: "doc-005", type: "free-frank", text: "In my professional opinion, Route Option B presents unacceptable geotechnical risk and should be abandoned despite being the preferred option in the community consultation", confidence: 81, page: 20, posX: 80, posY: 400, posW: 520, posH: 44, suggestedGround: "s7_2fi", appliedGround: null, status: "pending", reasoning: "", piConsideration: "", aiExplanation: "Professional engineering opinion that contradicts the community's preferred option. This is free and frank expression of professional judgement that could influence public debate about the project route.", source: "ai" },
